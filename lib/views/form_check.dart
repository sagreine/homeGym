...
class FormCheckView extends StatefulWidget {
  @override
  _FormCheckState createState() => new _FormCheckState();
}

class _FormCheckState extends State<FormCheckView> {
  File _image;
  List _recognitions;
  ...
  Future predictImagePicker() async {
    var __image = await ImagePicker().getImage(source: ImageSource.gallery);
    if (__image == null) return;
    setState(() {
      _image = File(__image.path);
      _busy = true;
    });
    predictImage(_image);
  }
